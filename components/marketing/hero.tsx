    ...
    <div className="my-10 flex w-full flex-col justify-center gap-1 px-3 py-4 text-center md:my-20 md:p-6">
      <div>
        <Badge variant="outline" className="backdrop-blur-[2px]">
          <Link
            href="https://github.com/Vette1123/next-starter-template-bun"
            target="_blank"
            rel="noreferrer"
      ...
      <div className="flex flex-col gap-6">
        ...
        >
          The Ultimate Next.js Template for Your Projects.
        </h1>
        <p className="mx-auto max-w-md text-balance text-lg text-muted-foreground md:max-w-xl md:text-xl">
          Kickstart your SaaS or any project with ease using our prebuilt
          components. Perfect for developers looking for a seamless bootstrap
          experience.
        </p>
      </div>
